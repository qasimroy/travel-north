...
<div class="container-fluid px-4">
    <div class="row float-end">
        <div class="">
            <a>
                <button class="btn text-white cta" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Add</button>
                        ...
                        <form class="row g-3 text-dark" method="POST" action="{{ route('user.bookings.store') }}">
                            ...
                            <div class="col-12">
                                <x-form-select label="Service Provider" name="service_provider_id"
                                    ...
                                    data-old-value="{{ old('service_provider_id') }}">
                                </x-form-select>
                            </div>
                            <div class="col-12" id="service-details">
                                <div class="visi row" id="tour">
                                    <div class="col-md-6">
                                        <x-form-select label="Origin" name="origin" placeholder="Select Your Origin"
                                            required>
                                    ...
                                    <div class="col-md-6">
                                        <x-form-select label="Destination" name="destination"
                                            placeholder="Select Your Destination" required>
                                            @foreach($cities as $city)
                                            <option value="{{ $city }}">{{ $city }}</option>
                                            @endforeach
                                        </x-form-select>
                                    ...
                                    <div class="col-md-6">
                                        <x-form-input name="persons" label="Persons" type="number" inputmode="numeric"
                                            required />
                                    </div>
                                    <div class="col-md-6">
