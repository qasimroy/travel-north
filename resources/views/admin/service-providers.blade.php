                ...
                @foreach ($serviceProvider as $ServiceProvider)
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('admin.service-providers.edit', ['ServiceProvider' => $ServiceProvider->id]) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="{{ route('admin.service-providers.destroy', ['ServiceProvider' => $ServiceProvider->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
