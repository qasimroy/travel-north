...
@section('content')
    <main>
        ...
        <section class="bg-white p-4">
            <div class="container">
                <h2 class="text-center">About Our Travel Services
                    <hr>
                    </h3>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 d-flex justify-content-start align-items-center">
                            <p class="lh-lg fs-5 ">
                                We are a trusted and reliable travel platform that offers a wide range of services to cater
                                to your
                                travel needs. Whether you're looking for car or bike rentals, hotel accommodations, coach
                                services, or
                                exciting tour packages, we've got you covered. Our mission is to make your travel experience
                                seamless and memorable.
                            </p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 d-flex justify-content-center ">
                            <img src="{{ asset('images/about-img.jpg') }}" class="img-fluid w-75 rounded shadow-lg"
                                alt="about-image">
                        </div>
                    </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                        <div class="card h-100 border-0 shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text lh-lg">Explore a wide range of services available for your travel needs.
                                    Find the perfect options that suit your preferences.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                        <div class="card h-100 border-0 shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text lh-lg">Customize your travel experience by creating your own package.
                                    Select services from various categories and build your ideal itinerary.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                        <div class="card h-100 border-0 shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text lh-lg">Once you've created your package, easily book it and secure your
                                    travel arrangements. Enjoy a hassle-free booking experience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 py-2">
                        <div class="card h-100 border-0 shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text lh-lg">Sit back, relax, and enjoy your travel experience. Make lasting
                                    memories as you explore exciting destinations and attractions.</p>
                            </div>
                        </div>
                    </div>
                </div>
