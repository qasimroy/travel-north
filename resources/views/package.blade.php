...
@section('content')
    <main class="" id="wrapper">
        <div class="container">
            <div>
                <h2 class="fs-2 m-0 py-4">Packages</h2>
            </div>
            <div>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="staticBackdrop{{ $package->id }}Label">Package
                                                                Details
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <p>We are providing a tour plan for {{ $package->days }} days
                                                                from
                                                                <b>{{ $package->origin }}</b> to
                                                                <b>{{ $package->destination }}</b>
                                                                which will start on {{ $package->start_date }} and will end
                                                                on
                                                                {{ $package->end_date }}.
                                                            </p>
